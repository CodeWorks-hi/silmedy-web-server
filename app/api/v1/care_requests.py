...
@router.get(
    "/care-requests/waiting",
    tags=["의사 - 진료 관리"],
    summary="대기 중인 진료 요청을 조회합니다.",
    description="로그인한 의사에게 배정된 대기 환자 목록을 조회합니다."
)
...
@router.put(
    "/care-requests/{request_id}/complete",
    tags=["의사 - 진료 관리"],
    summary="진료 요청을 완료 처리합니다.",
    description="특정 진료 요청을 완료 처리하고 완료 시간을 기록합니다."
)
...
@router.get(
    ...
    tags=["의사 - 진료 관리"],
    summary="진료 요청의 상세 정보를 조회합니다.",
    description="특정 진료 요청의 상세 정보 (환자 포함)를 반환합니다."
)
